...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    ...
    openGraph: {
      ...
      publishedTime,
      type: "article",
      url: `https://www.dev.parthkapoor.me/blog/${post.slug}`,
      images: [
        {
          url: `https://www.dev.parthkapoor.me/og/blog?title=${post.metadata.title}`,
        },
      ],
    },
    twitter: {
      ...
      images: [
        `https://www.dev.parthkapoor.me/og/blog?title=${post.metadata.title}&top=${publishedTime}`,
      ],
    },
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: post.metadata.description,
            image: `https://dev.parthkapoor.me/og/blog?title=${
              post.metadata.title
            }&top=${formatDate(post.metadata.date)}`,
            url: `https://dev.parthkapoor.me/blog/${post.slug}`,
            author: {
              "@type": "Person",
              name: "Parth Kapoor",
            },
